		...
		*/
		...
		protected:
			...
			*/
			...
			void  _construct_tet_orientation(CTet* pT, int tID, int * v);
			/*! construct faces */
		...
		template <typename CTVertex, typename CVertex, typename CHalfEdge, typename CTEdge, typename CEdge, typename CHalfFace, typename CFace, typename CTet>
		void CTMesh<CTVertex, CVertex, CHalfEdge, CTEdge, CEdge, CHalfFace, CFace, CTet>::_load(const char * input, bool checkOrientation = false_)
		{
			m_maxVertexId = 0;
		...
		template <typename CTVertex, typename CVertex, typename CHalfEdge, typename CTEdge, typename CEdge, typename CHalfFace, typename CFace, typename CTet>
		void CTMesh<CTVertex, CVertex, CHalfEdge, CTEdge, CEdge, CHalfFace, CFace, CTet>::_load_t(const char * input, bool checkOrientation = false)
		{
			m_maxVertexId = 0;
		...
		template <typename CTVertex, typename CVertex, typename CHalfEdge, typename CTEdge, typename CEdge, typename CHalfFace, typename CFace, typename CTet>
		void CTMesh<CTVertex, CVertex, CHalfEdge, CTEdge, CEdge, CHalfFace, CFace, CTet>::_construct_tet_orientation(CTet* pT, int tId, int  v[4])
		{
			//orient the tet 
